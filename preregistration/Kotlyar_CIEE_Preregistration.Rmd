...
Since we visually observed this effect and we are now testing it experimentally, we expect there to be quite a large effect size. We used a power analysis (`pwr.chisq.test` from the pwr package) with a large effect size of .50 at the standard .05 alpha and .95 power, the desired sample size was 52.
